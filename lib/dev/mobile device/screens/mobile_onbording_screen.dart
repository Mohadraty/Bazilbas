...
class MobileOnbordingScreen extends StatefulWidget {
  const MobileOnbordingScreen({super.key});

  @override
  State<MobileOnbordingScreen> createState() => _MobileOnbordingScreenState();
}

class _MobileOnbordingScreenState extends State<MobileOnbordingScreen> {
  @override
